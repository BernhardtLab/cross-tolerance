...
write_csv(traits, "data-processed/all-SS-traits-sliding-window-variable.csv")
...
ggsave("figures/tpcs-sliding-window-per-strain-variable.png", width = 18, height = 14)
