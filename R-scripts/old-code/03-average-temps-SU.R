...
###July 25, 30 deg, 24 hr
july25_30_temp <- read_excel("C:/Users/sveta/Documents/B Lab/cross-tolerance/data-raw/July2523_30C.xlsx", sheet = 1, range = "b35:ct36")
View(july25_30_temp)
